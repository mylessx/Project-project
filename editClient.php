...
<?php
	    ...
	    echo "<input type=\"text\" client_id=\"fname\" name=\"age\" placeholder=\"clients Age ..\" value=\"$row[age]\">";
        echo "<br>";
        echo "<br>";
		echo "<label for=\"fname\">Date Vaccinated (1st shot): </label>";
	    echo "<input type=\"date\" client_id=\"fname\" name=\"dateVaccinated\" placeholder=\"Vaccination Date (1st Shot)..\" value=\"$row[dateVaccinated]\">";
        echo "<br>";
        echo "<br>";
		echo "<label for=\"fname\">Vaccine Brand (1st shot): </label>";
		echo "<input type=\"text\" client_id=\"fname\" name=\"brandname\" placeholder=\"Vaccine brand (1st Shot)..\" value=\"$row[brandname]\">";
        echo "<br>";
        echo "<br>";
		echo "<label for=\"fname\">Side Effect/s (1st shot): </label>";
		echo "<input type=\"text\" client_id=\"fname\" name=\"side_effects\" placeholder=\"Side Effect (1st Shot)..\" value=\"$row[side_effects]\">";
        echo "<br>";
        echo "<br>";
		echo "<label for=\"fname\">Status (1st shot): </label>";
		echo "<input type=\"text\" client_id=\"fname\" name=\"status\" placeholder=\"clients Status (1st Shot)..\" value=\"$row[status]\">";
        echo "<br>";
        echo "<br>";
        echo "<label for=\"fname\">Facility Name (1st shot): </label>";
		echo "<input type=\"text\" client_id=\"fname\" name=\"facname\" placeholder=\"Facility name (1st Shot)...\" value=\"$row[facname]\">";
        echo "<br>";
        echo "<br>";
        echo "<label for=\"fname\">Medical History: </label>";
		echo "<input type=\"text\" client_id=\"fname\" name=\"medicalhistory\" placeholder=\"medical history...\" value=\"$row[medicalhistory]\">";
        echo "<br>";
        echo "<br>";
